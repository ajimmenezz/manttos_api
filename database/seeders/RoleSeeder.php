...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $adminCliente->syncPermissions([
            ...
            'directories.view',
            'devices.view', 'devices.export', 'devices.archive',
            'floor-plans.view',
        ...
        $adminSitio->syncPermissions([
            ...
            'devices.view', 'devices.create', 'devices.edit', 'devices.toggle-status', 'devices.import', 'devices.export', 'devices.archive',
